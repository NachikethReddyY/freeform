...
- [ ] Slides and presentation: finish light/dark fit, transitions, laser trail, remote, and browser-visible proof. Light/dark first-slide captures and a slow continuous laser regression pass; presentation stage has 6/6 focused tests and the full presentation suite 27/27. Live trail gesture and transition visuals remain unverified.
